...
- Slash commands for common jobs: `/analyze-network`, `/community-detection`, `/centrality`, `/visualize`, `/import-and-explore`, `/beautify`, `/verify-claim`, `/text-network`, `/teach`, `/whatif`, `/counterfactual`
...
|-----------|-------------|
| **Slash commands** | `/analyze-network`, `/community-detection`, `/centrality`, `/visualize`, `/import-and-explore`, `/beautify`, `/verify-claim`, `/text-network`, `/teach`, `/whatif`, `/counterfactual` |
