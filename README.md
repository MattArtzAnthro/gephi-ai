...
- 107 tools covering the whole workflow: build, analyze, style, lay out, filter, and export
...
| MCP Server | `mcp-server/` | Python server that exposes 107 Gephi tools via MCP |
...
These agents get all 107 tools. To give them the network-analysis guidance as well, copy the skill folder into your agent's skills directory:
...
- **references/tool-reference.md** — Complete API reference for all 107 tools
