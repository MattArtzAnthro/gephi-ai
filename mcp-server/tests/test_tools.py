...
def test_all_109_tools_registered():
    ...
    assert len(names) == 109, f"expected 109 tools, found {len(names)}"
    for expected in (
        ...
        "gephi_export_screenshot", "gephi_community_stability", "gephi_export_legend", "gephi_session_receipt",
    ):
