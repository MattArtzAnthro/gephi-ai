...
2. **Confirm there is a graph**: Call `gephi_get_project_info`. If there is no project or the graph is empty, say so and suggest opening a file in Gephi or running `/import-and-explore <path>`; stop.
